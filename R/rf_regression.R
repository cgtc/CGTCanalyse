...
#'
#' This function performs tuning of a Random Forest regression model on a given dataset.
...
#' @param metric A string specifying the metric to be used for model evaluation (e.g., "rmse" for regression).
